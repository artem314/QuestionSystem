         ...
         //   /question/question
            ...
            */
            ...
            foreach (KeyValuePair<int, GenQuestion> sug in suggestions)
            {
                ...
                //разбиение предложения на слова
                string[] words = sug.Value.Suggestion.Split(delimiterChars,StringSplitOptions.RemoveEmptyEntries);
                ...
                //добавить проверку, если вопрос не составлен (меньше 3 слов) удалить вырождение
                sug.Value.QuestionText = string.Join(" ",result) + '?';
